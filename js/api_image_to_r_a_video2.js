...
async function submit() {
    try {
        ...
        const paramData = {
            ...
            model: '3', // 模型类型，你按4种模型来设置，0:高级  1:中级  2:初级  3:体验版本
            duration: 4, // 视频时长（秒）4秒、8秒、10秒
            audio: true, // 是否启用语音输出
            aspect_ratio: "16:9", // 是否启用语音输出 16:9、9:16、4:3、3:4、1:1
            resolution: "360p", // 是否启用语音输出 360p、720p、1080p
